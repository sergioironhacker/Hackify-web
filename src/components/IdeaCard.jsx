...
const IdeaCard = ({
  ...
  return (
    <div
      key={index}
      className="bg-white rounded-lg shadow-lg overflow-hidden mt-6 font-bold flex flex-col items-center"
    >
      ...
      <div className="p-6 text-center">
        ...
        <Link
          to={`/ideas/${id}`}
          className="inline-block bg-green-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md"
        >
          Ver más detalles
        </Link>
      </div>

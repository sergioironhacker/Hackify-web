    ...
    <div className="p-4 mt-5 text-green-400">
      ...
      <div className="mb-6 text-green-500">
        <p className="font-bold mb-4 text-green-500 mt-9">
          En Hackify, estamos dedicados a romper las barreras financieras que
          impiden que las ideas brillantes se conviertan en realidad. Nuestra
          empresa se especializa en respaldar proyectos innovadores que desafían
          el status quo y abren nuevos horizontes en diversas industrias.
        </p>

      ...
      {loading ? (
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <div className="text-center">
            ...
            <p className='font-bold text-sm'>Necesita recaudar: {idea.contributionMax}</p>
            ...
            <div className="mt-4">
              <label htmlFor="paymentAmount" className="block font-bold text-sm">Cantidad a contribuir(€):</label>
              <input
                type='number'
                id="paymentAmount"
                name="paymentAmount"
